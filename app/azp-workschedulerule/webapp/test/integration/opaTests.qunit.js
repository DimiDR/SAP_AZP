...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "azpworkschedulerule/test/integration/FirstJourney",
    "azpworkschedulerule/test/integration/WorkScheduleRuleListJourney",
    "azpworkschedulerule/test/integration/WorkScheduleRuleObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
